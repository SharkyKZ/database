...
/**
 * Test class for \Joomla\Database\Mysql\MysqlQuery.
 *
 * @since  1.1
 */
class MysqlQueryTest extends TestCase
{
	...
	/**
	 * Test for the MysqlQuery::__string method for a 'update' case.
	 *
	 * @return  void
	 *
	 * @since   1.1
	...
	public function testSetLimitAndOffset()
	{
		...
		$this->assertThat(
			trim(TestHelper::getValue($q, 'limit')),
			$this->equalTo('5'),
			'Tests limit was set correctly.'
		);

		$this->assertThat(
			trim(TestHelper::getValue($q, 'offset')),
			$this->equalTo('10'),
	...
	/**
	 * Tests the MysqlQuery::processLimit method.
	 *
	 * @return  void
	 *
	 * @since   1.1
